...
int main()
{
    ...
    dataBarang barang1 = dataBarang("Pensil   ", "BRG001", 1500);
    dataBarang barang2 = dataBarang("Penghapus", "BRG002", 1000);
    dataBarang barang3 = dataBarang("Penggaris", "BRG003", 2500);
    dataBarang barang4 = dataBarang("Ballpoint", "BRG004", 3000);
    dataBarang barang5 = dataBarang("Tipe-x   ", "BRG005", 3500);
